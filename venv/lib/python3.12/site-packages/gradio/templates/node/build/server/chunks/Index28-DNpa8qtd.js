import { B as Block, S as Static, o as IconButtonWrapper, F as FullscreenButton, X as BlockTitle, n as Empty, ar as LineChart, al as globals } from './2-4stoy7MV.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-Do1vcamZ.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
...
//# sourceMappingURL=Index28-DNpa8qtd.js.map
