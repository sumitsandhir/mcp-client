...
import { B as Block, S as Static, j as BlockLabel, Y as Code$2, n as Empty, q as IconButton, K as Copy$1, D as DownloadLink, u as Download$1, o as IconButtonWrapper, Z as getWorkerProxyContext } from './2-4stoy7MV.js';
...
const lang_map = {
  python: () => import('./index33-D_RePYNR.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index34-Clri6PTR.js'),
      import('./frontmatter-D8AJ97p9.js')
    ]);
  ...
  json: () => import('./index38-DqLIHQYZ.js').then((m) => m.json()),
  html: () => import('./index35-es-RY6bP.js').then((m) => m.html()),
  css: () => import('./index36-CYV29Xpt.js').then((m) => m.css()),
  javascript: () => import('./index37-Cvg8L94J.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index37-Cvg8L94J.js').then(
...
//# sourceMappingURL=Index16-dQTGRVeS.js.map
